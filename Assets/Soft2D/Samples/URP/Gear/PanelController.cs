...
public class PanelController : MonoBehaviour
{
    ...
    public void Update()
    {
        ...
        {
            movingCubeRb.linearVelocity = new Vector3(movingSpeed,0,0);
        ...
        if (Input.GetKeyDown(KeyCode.Space) && !stopEmitting)
        {
            ...
            movingCubeRb.linearVelocity = new Vector3(0, 0, movingSpeed / 5);
    ...
    private void MovePrisms()
    {
        ...
        {
            prism.linearVelocity = prism.transform.position.z <= -0.03f ? Vector3.zero : new Vector3(0, 0, -movingSpeed / 10);
        }
    }

    private void RemoveCollider(GameObject collider)
    {
        collider.GetComponent<Rigidbody>().linearVelocity = new Vector3(0, 0, movingSpeed / 5);
